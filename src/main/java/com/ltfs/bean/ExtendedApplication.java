...
@Entity
@Table(name = "Tbl_ExtendedApplication")
public class ExtendedApplication implements Serializable
{
	...
	@Column(name = "ExtndApp_SrNo", unique = true, nullable = false)
	private Long SrNo;
	@Column(name = "Id", columnDefinition = "VARCHAR(50)")
	private String Id;
	@Column(name = "Name", columnDefinition = "VARCHAR(100)")
	private String Name;
	@Column(name = "Tractor_Loan_Amount__c", columnDefinition = "VARCHAR(100)")
	private String Tractor_Loan_Amount__c;
	@Column(name = "Is_Loan_Amt_Changed__c", columnDefinition = "VARCHAR(100)")
	private String Is_Loan_Amt_Changed__c;
	@Column(name = "Imd_Applicable__c", columnDefinition = "VARCHAR(100)")
	private String Imd_Applicable__c;
	@Column(name = "Dealer_Subvention_Flag__c", columnDefinition = "VARCHAR(100)")
	private String Dealer_Subvention_Flag__c;
	@Column(name = "BPI_FLag__c", columnDefinition = "VARCHAR(20)")
	private String BPI_FLag__c;
	@Column(name = "MTRP_Loan__c", columnDefinition = "VARCHAR(100)")
	private String MTRP_Loan__c;
	@Column(name = "CII_Application__c", columnDefinition = "VARCHAR(100)")
	private String CII_Application__c;
	@Column(name = "RSA_Ref_Id__c", columnDefinition = "VARCHAR(50)")
	private String RSA_Ref_Id__c;
	@Column(name = "CLI_Error__c", columnDefinition = "VARCHAR(50)")
	private String CLI_Error__c;
	@Column(name = "Customer_Type__c", columnDefinition = "VARCHAR(50)")
	private String Customer_Type__c;
	@Column(name = "is_RSA_App__c", columnDefinition = "VARCHAR(20)")
	private String is_RSA_App__c;
	@Column(name = "LMS_EMI__c", columnDefinition = "VARCHAR(100)")
	private String LMS_EMI__c;
	@Column(name = "HMSI_app__c", columnDefinition = "VARCHAR(100)")
	...
	@Column(name = "FUNDINGELIGIBILITY__c", columnDefinition = "VARCHAR(100)")
	private String FUNDINGELIGIBILITY__c;
	@Column(name = "IMPLEMENTFUNDINGELIGIBILITY__c", columnDefinition = "VARCHAR(100)")
	private String IMPLEMENTFUNDINGELIGIBILITY__c;
	@Column(name = "Implement_Loan_Amount__c", columnDefinition = "VARCHAR(100)")
	private String Implement_Loan_Amount__c;
	@Column(name = "TRACTORLTV__c", columnDefinition = "VARCHAR(100)")
	private String TRACTORLTV__c;
	@Column(name = "IMPLEMENTLTV__c", columnDefinition = "VARCHAR(100)")
	private String IMPLEMENTLTV__c;
	@Column(name = "LTVASSETCOSTIMPLEMENT__c", columnDefinition = "VARCHAR(100)")
	private String LTVASSETCOSTIMPLEMENT__c;
	@Column(name = "LTVDLPIMPLEMENT__c", columnDefinition = "VARCHAR(100)")
	private String LTVDLPIMPLEMENT__c;
	@Column(name = "LTVMAXIMPLEMENT__c", columnDefinition = "VARCHAR(100)")
	private String LTVMAXIMPLEMENT__c;
	@Column(name = "Disbursed_To__c", columnDefinition = "VARCHAR(100)")
	private String Disbursed_To__c;
	@Column(name = "Old_Processing_Fee__c", columnDefinition = "VARCHAR(100)")
	private String Old_Processing_Fee__c;
	@Column(name = "CLI_Deviation_Status__c", columnDefinition = "VARCHAR(100)")
	private String CLI_Deviation_Status__c;
	@Column(name = "CLI_Deviation_Flag__c", columnDefinition = "VARCHAR(20)")
	private String CLI_Deviation_Flag__c;
	@Column(name = "CLI_Deviation_Reason__c", columnDefinition = "VARCHAR(100)")
	...
	@Column(name = "File_Tracking_Remark__c", columnDefinition = "VARCHAR(100)")
	private String File_Tracking_Remark__c;
	@Column(name = "Invoice_number_2__c", columnDefinition = "VARCHAR(100)")
	private String Invoice_number_2__c;
	@Column(name = "Split_Sanction_Letter__c", columnDefinition = "VARCHAR(100)")
	private String Split_Sanction_Letter__c;
	@Column(name = "Top_up_Loan_Amount__c", columnDefinition = "VARCHAR(100)")
	private String Top_up_Loan_Amount__c;
	@Column(name = "BT_Loan_Amount__c", columnDefinition = "VARCHAR(100)")
	private String BT_Loan_Amount__c;
	@Column(name = "CLI_Deviation_Count__c", columnDefinition = "VARCHAR(100)")
	private String CLI_Deviation_Count__c  ;
	@Column(name = "PDC_Mandate_Done__c", columnDefinition = "VARCHAR(100)")
	private String PDC_Mandate_Done__c;
	@Column(name = "Current_Owner_Pincode__c", columnDefinition = "VARCHAR(100)")
	private String Current_Owner_Pincode__c;
	@Column(name = "Imd_Cheque_Amount__c", columnDefinition = "VARCHAR(100)")
	private String Imd_Cheque_Amount__c;
	@Column(name = "Imd_Cheque_Date__c", columnDefinition = "VARCHAR(100)")
	...
	@Column(name = "Imd_Deposit_Slip_Number__c", columnDefinition = "VARCHAR(100)")
	private String Imd_Deposit_Slip_Number__c;
	@Column(name = "Imd_Drawn_On__c", columnDefinition = "VARCHAR(100)")
	private String Imd_Drawn_On__c;
	@Column(name = "Imd_Receipt_Date__c", columnDefinition = "VARCHAR(100)")
	private String Imd_Receipt_Date__c;
	@Column(name = "Imd_Total_Amount__c", columnDefinition = "VARCHAR(100)")
	private String Imd_Total_Amount__c;
	@Column(name = "Imd_Mode_Of_Payment__c", columnDefinition = "VARCHAR(100)")
	private String Imd_Mode_Of_Payment__c;
	@Column(name = "Imd_Receipt_Number__c", columnDefinition = "VARCHAR(100)")
	private String Imd_Receipt_Number__c;
	@Column(name = "Imd_Status__c", columnDefinition = "VARCHAR(50)")
	private String Imd_Status__c;
	@Column(name = "Imd_In_Favour_OF__c", columnDefinition = "VARCHAR(100)")
	private String Imd_In_Favour_OF__c;
	@Column(name = "Flat_Rate__c", columnDefinition = "VARCHAR(100)")
	private String Flat_Rate__c;
	@Column(name = "Max_Flat_Rate__c", columnDefinition = "VARCHAR(100)")
	private String Max_Flat_Rate__c;
	@Column(name = "Min_Accounting_IRR__c", columnDefinition = "VARCHAR(100)")
	private String Min_Accounting_IRR__c;
	@Column(name = "Max_Accounting_IRR__c", columnDefinition = "VARCHAR(100)")
	private String Max_Accounting_IRR__c;
	@Column(name = "Min_Financial_IRR__c", columnDefinition = "VARCHAR(100)")
	private String Min_Financial_IRR__c;
	@Column(name = "Max_Financial_IRR__c", columnDefinition = "VARCHAR(100)")
	private String Max_Financial_IRR__c;
	@Column(name = "valuation_price__c", columnDefinition = "VARCHAR(100)")
	private String valuation_price__c;
	@Column(name = "valuation_date__c", columnDefinition = "VARCHAR(100)")
	private String valuation_date__c;
	@Column(name = "old_opportunity_id__c", columnDefinition = "VARCHAR(100)")
	private String old_opportunity_id__c;
	@Column(name = "RTO_Code__c", columnDefinition = "VARCHAR(100)")
	private String RTO_Code__c;
	@Column(name = "Partner_Name__c", columnDefinition = "VARCHAR(100)")
	private String Partner_Name__c;
	@Column(name = "Existing_Application__c", columnDefinition = "VARCHAR(100)")
	private String Existing_Application__c;
	@Column(name = "First_Emi_Amount__c", columnDefinition = "VARCHAR(100)")
	private String First_Emi_Amount__c;
	@Column(name = "Invoice_Date__c", columnDefinition = "VARCHAR(100)")
	private String Invoice_Date__c;
	@Column(name = "Hmr_Km__c", columnDefinition = "VARCHAR(100)")
	private String Hmr_Km__c;
	@Column(name = "Business_Stability__c", columnDefinition = "VARCHAR(100)")
	private String Business_Stability__c;
	@Column(name = "Annual_Liabilities__c", columnDefinition = "VARCHAR(100)")
	private String Annual_Liabilities__c;
	@Column(name = "Implement_Category__c", columnDefinition = "VARCHAR(100)")
	private String Implement_Category__c;
	@Column(name = "Total_Loan_Amount__c", columnDefinition = "VARCHAR(100)")
	...
	@Column(name = "is_Passbook_Required__c", columnDefinition = "VARCHAR(100)")
	...
	public String getTractor_Loan_Amount__c() {
		return Tractor_Loan_Amount__c;
	}
	public void setTractor_Loan_Amount__c(String tractor_Loan_Amount__c) {
		Tractor_Loan_Amount__c = tractor_Loan_Amount__c;
	}
	public String getIs_Loan_Amt_Changed__c() {
		return Is_Loan_Amt_Changed__c;
	}
	public void setIs_Loan_Amt_Changed__c(String is_Loan_Amt_Changed__c) {
		Is_Loan_Amt_Changed__c = is_Loan_Amt_Changed__c;
	}
	public String getImd_Applicable__c() {
		return Imd_Applicable__c;
	}
	public void setImd_Applicable__c(String imd_Applicable__c) {
		Imd_Applicable__c = imd_Applicable__c;
	}
	public String getDealer_Subvention_Flag__c() {
		return Dealer_Subvention_Flag__c;
	}
	public void setDealer_Subvention_Flag__c(String dealer_Subvention_Flag__c) {
		Dealer_Subvention_Flag__c = dealer_Subvention_Flag__c;
	}
	public String getBPI_FLag__c() {
		return BPI_FLag__c;
	}
	public void setBPI_FLag__c(String bPI_FLag__c) {
		BPI_FLag__c = bPI_FLag__c;
	}
	public String getMTRP_Loan__c() {
		return MTRP_Loan__c;
	}
	public void setMTRP_Loan__c(String mTRP_Loan__c) {
		MTRP_Loan__c = mTRP_Loan__c;
	}
	public String getCII_Application__c() {
		return CII_Application__c;
	}
	public void setCII_Application__c(String cII_Application__c) {
		CII_Application__c = cII_Application__c;
	}
	public String getRSA_Ref_Id__c() {
		return RSA_Ref_Id__c;
	}
	public void setRSA_Ref_Id__c(String rSA_Ref_Id__c) {
		RSA_Ref_Id__c = rSA_Ref_Id__c;
	}
	public String getCLI_Error__c() {
		return CLI_Error__c;
	}
	public void setCLI_Error__c(String cLI_Error__c) {
		CLI_Error__c = cLI_Error__c;
	}
	public String getCustomer_Type__c() {
		return Customer_Type__c;
	}
	public void setCustomer_Type__c(String customer_Type__c) {
		Customer_Type__c = customer_Type__c;
	}
	public String getIs_RSA_App__c() {
		return is_RSA_App__c;
	}
	public void setIs_RSA_App__c(String is_RSA_App__c) {
		this.is_RSA_App__c = is_RSA_App__c;
	}
	public String getLMS_EMI__c() {
		return LMS_EMI__c;
	}
	public void setLMS_EMI__c(String lMS_EMI__c) {
		LMS_EMI__c = lMS_EMI__c;
	}
	...
	public ExtendedApplication(String id, String name, String tractor_Loan_Amount__c, String is_Loan_Amt_Changed__c,
			String imd_Applicable__c, String dealer_Subvention_Flag__c, String bPI_FLag__c, String mTRP_Loan__c,
			String cII_Application__c, String rSA_Ref_Id__c, String cLI_Error__c, String customer_Type__c,
			String is_RSA_App__c, String lMS_EMI__c, String hMSI_app__c, String nRI_Flag__c, String bureau_Error__c,
	...
	public String toString() {
		return "ExtendedApplication [SrNo=" + SrNo + ", Id=" + Id + ", Name=" + Name + ", Tractor_Loan_Amount__c="
				+ Tractor_Loan_Amount__c + ", Is_Loan_Amt_Changed__c=" + Is_Loan_Amt_Changed__c + ", Imd_Applicable__c="
				+ Imd_Applicable__c + ", Dealer_Subvention_Flag__c=" + Dealer_Subvention_Flag__c + ", BPI_FLag__c="
				+ BPI_FLag__c + ", MTRP_Loan__c=" + MTRP_Loan__c + ", CII_Application__c=" + CII_Application__c
				+ ", RSA_Ref_Id__c=" + RSA_Ref_Id__c + ", CLI_Error__c=" + CLI_Error__c + ", Customer_Type__c="
				+ Customer_Type__c + ", is_RSA_App__c=" + is_RSA_App__c + ", LMS_EMI__c=" + LMS_EMI__c
				+ ", HMSI_app__c=" + HMSI_app__c + ", NRI_Flag__c=" + NRI_Flag__c + ", Bureau_Error__c="
				+ Bureau_Error__c + ", FUNDINGELIGIBILITY__c=" + FUNDINGELIGIBILITY__c
				+ ", IMPLEMENTFUNDINGELIGIBILITY__c=" + IMPLEMENTFUNDINGELIGIBILITY__c + ", Implement_Loan_Amount__c="
				+ Implement_Loan_Amount__c + ", TRACTORLTV__c=" + TRACTORLTV__c + ", IMPLEMENTLTV__c=" + IMPLEMENTLTV__c
				+ ", LTVASSETCOSTIMPLEMENT__c=" + LTVASSETCOSTIMPLEMENT__c + ", LTVDLPIMPLEMENT__c="
				+ LTVDLPIMPLEMENT__c + ", LTVMAXIMPLEMENT__c=" + LTVMAXIMPLEMENT__c + ", Disbursed_To__c="
				+ Disbursed_To__c + ", Old_Processing_Fee__c=" + Old_Processing_Fee__c + ", CLI_Deviation_Status__c="
				+ CLI_Deviation_Status__c + ", CLI_Deviation_Flag__c=" + CLI_Deviation_Flag__c
				+ ", CLI_Deviation_Reason__c=" + CLI_Deviation_Reason__c + ", File_Tracking_Status__c="
				+ File_Tracking_Status__c + ", File_Tracking_Remark__c=" + File_Tracking_Remark__c
				+ ", Invoice_number_2__c=" + Invoice_number_2__c + ", Split_Sanction_Letter__c="
				+ Split_Sanction_Letter__c + ", Top_up_Loan_Amount__c=" + Top_up_Loan_Amount__c + ", BT_Loan_Amount__c="
				+ BT_Loan_Amount__c + ", CLI_Deviation_Count__c=" + CLI_Deviation_Count__c + ", PDC_Mandate_Done__c="
				+ PDC_Mandate_Done__c + ", Current_Owner_Pincode__c=" + Current_Owner_Pincode__c
				+ ", Imd_Cheque_Amount__c=" + Imd_Cheque_Amount__c + ", Imd_Cheque_Date__c=" + Imd_Cheque_Date__c
				+ ", Imd_Cheque_Number__c=" + Imd_Cheque_Number__c + ", Imd_City__c=" + Imd_City__c
				+ ", Imd_Deposit_Slip_Number__c=" + Imd_Deposit_Slip_Number__c + ", Imd_Drawn_On__c=" + Imd_Drawn_On__c
				+ ", Imd_Receipt_Date__c=" + Imd_Receipt_Date__c + ", Imd_Total_Amount__c=" + Imd_Total_Amount__c
				+ ", Imd_Mode_Of_Payment__c=" + Imd_Mode_Of_Payment__c + ", Imd_Receipt_Number__c="
				+ Imd_Receipt_Number__c + ", Imd_Status__c=" + Imd_Status__c + ", Imd_In_Favour_OF__c="
				+ Imd_In_Favour_OF__c + ", Flat_Rate__c=" + Flat_Rate__c + ", Max_Flat_Rate__c=" + Max_Flat_Rate__c
				+ ", Min_Accounting_IRR__c=" + Min_Accounting_IRR__c + ", Max_Accounting_IRR__c="
				+ Max_Accounting_IRR__c + ", Min_Financial_IRR__c=" + Min_Financial_IRR__c + ", Max_Financial_IRR__c="
				+ Max_Financial_IRR__c + ", valuation_price__c=" + valuation_price__c + ", valuation_date__c="
				+ valuation_date__c + ", old_opportunity_id__c=" + old_opportunity_id__c + ", RTO_Code__c="
				+ RTO_Code__c + ", Partner_Name__c=" + Partner_Name__c + ", Existing_Application__c="
